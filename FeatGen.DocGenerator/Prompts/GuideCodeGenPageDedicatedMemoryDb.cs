...
namespace FeatGen.ReportGenerator.Prompts
{
    public class GuideCodeGenPageDedicatedMemoryDb
    {
        ...
        public static string GenerateInterfacesV2(Specification spec, ReportCodeGuide rcg, string pageId, string menuItem, string sharedMemoryDBCode)
        {
            string rawPrompt = """
        ...
        public static string DefineDedicatedMemoryDbModelV2(Specification spec, ReportCodeGuide rcg, string pageId, string menuItem, string interfaceDefinition)
        {
            string rawPrompt = """
        ...
        public static string GenerateDedicatedMemoryDBCodeV2(Specification spec, ReportCodeGuide rcg, string pageId, string menuItem, string interfacesDefinition, string dedicatedDbModels)
        {
            string rawPrompt = """
