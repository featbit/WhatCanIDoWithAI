    ...
    public class GuideCodeGenPageComponent
    {
            ...
            string menuItem, string apiCode, string cssCode)
        {
            string rawPrompt = """
                ...
                Here's API endpoints, functions and the fake data that the page can use for data exchange. This API endpoints are coded in the file `/app/api/###{menu_item}###.js`:
